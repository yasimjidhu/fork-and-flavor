...
export default function RecipeDetails() {
  ...
  // Ensure that instructions is an array
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            <h2 className="text-2xl font-semibold mb-6 text-gray-800 font-primary">Ingredients</h2>
          ...
          <div className="md:col-span-2 bg-white rounded-lg shadow-lg p-6 font-primary">
